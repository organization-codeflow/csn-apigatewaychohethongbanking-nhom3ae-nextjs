# csn-apigatewaychohethongbanking-nhom3ae-nextjs
...
```bash
git clone https://github.com/organization-codeflow/csn-apigatewaychohethongbanking-nhom3ae-nextjs.git
cd csn-apigatewaychohethongbanking-nhom3ae-nextjs
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-apigatewaychohethongbanking-nhom3ae-nextjs
- Xem các metrics:
